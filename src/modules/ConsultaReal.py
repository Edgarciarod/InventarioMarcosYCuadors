...
class WinConsultaReal:
    ...
    def addTreeView(self):
        ...
        cursor.execute("""SELECT inventario_real.cantidad, maestro_moldura.clave_interna, maestro_moldura.clave_proveedor,
                       maestro_moldura.nombre_moldura, maestro_moldura.descripcion, maestro_moldura.precio_unitario,
                       maestro_moldura.punto_reorden
                       FROM inventario_real, maestro_moldura
                       WHERE inventario_real.moldura_id = maestro_moldura.moldura_id
